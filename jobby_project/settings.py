...
SECRET_KEY = os.environ.get('SECRET_KEY', 'your-fallback-secret-key-here-change-this')
...
ROOT_URLCONF = 'jobby_project.urls'
...
WSGI_APPLICATION = 'jobby_project.wsgi.application'
...
if not DEBUG:
    ...
    DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@jobby.com')
